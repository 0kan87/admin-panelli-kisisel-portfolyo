...
<div class="col-xs-12 col-sm-6 col-md-3">
	...
	<div  class= "input-group" > 
 	...
 	<input  type= "color" name="renkkodu" class= "form-control" value="<?php echo htmlentities($row_sagyetenekduzenle['renkkodu'], ENT_COMPAT, 'utf-8'); ?>"  aria-describedby= "basic-addon1" > 
	</div> 
    </div>
</div>
<div class="col-xs-12 col-sm-6 col-md-3">
