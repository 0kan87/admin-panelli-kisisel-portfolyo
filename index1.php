				...
				<div id="tab_section">
					<div id="splash" class="tab_content"><!-- Main page -->
						<div class="author_info">
							<div class="user_desc"><?php echo $row_ayarlar['ilksayfabaslik']; ?></div>
							<div class="phone_num">
							...
							<div class="addition">
								...
								<p><?php echo $row_ayarlar['ilksayfaicerik']; ?></a><p>
                                <?php $xml = simplexml_load_file('http://okandiyebiri.com/rss'); ?> 
								<?php     
                                 $s=0; 
							...
							<div class="portfolio_items">
                               ...
                               <article class="<?php echo $row_resim['aciklama']; ?>">
									<div class="post_pic portfolio_post_pic">
										<a href="img/<?php echo $row_resim['resim']; ?>.jpg" class="w_hover img-link img-wrap" rel="prettyPhoto[gallery]" title="Portfolio item">
											<span class="overlay"></span>
											<span class="link-icon"><img src="images/magnify.png" height="60" width="60" alt="<?php echo $row_resim['altbaslik']; ?>"></span>
											<img src="img/<?php echo $row_resim['resim']; ?>.jpg" height="400" width="600" alt="<?php echo $row_resim['altbaslik']; ?>">
											<span class="caption">
												<h4 class="post_title"><?php echo $row_resim['ustbaslik']; ?></h4>
